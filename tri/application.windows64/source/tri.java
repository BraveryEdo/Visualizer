...
public class tri extends PApplet {
...
public void draw() {
  ...
  fill(218, 222, 31, 150);
  ring(width/2, height/2, 6, 100 - r2/1.5f, t, true);
  fill(229, 35, 35, 100);
  ring(width/2, height/2, 11, 125, t, true);
  fill(229, 136, 35, 100);
  ring(width/2, height/2, 10, 125, -t, true);
  fill(239, 255, 67, 100);
  ring(width/2, height/2, 12, 125, 1.5f*t, true);
  fill(255, 255, 255, 10);
  ...
  ring(width/2, height/2, 100, 177.5f, -.75f*t+2*s, false);
  ring(width/2, height/2, 100, 175, -.75f*t+2*s + PI/100, true);
...
public void equalizerRing(float _x, float _y, int nbars, float t) {
  ...
  float mult = 1;
  if (pattern== 0) mult = 1.25f; 

  float o_rot = -.75f*t+2*s;
  float i_rad = 187-5*s;
...
public void bars(float _x, float _y, float low, float min, float max, float rot) {
...
public void fourLine(float x1, float y1, float x2, float y2, float tr, float tb, float tg, float ta, float br, float bb, float bg, float ba) {
  //bottom left
  stroke(br, bb, bg, ba);
...
public void tri(float _x, float _y, float _r, float _s, boolean ori) {
  // _x, _y = center point
  // _r = rotation (radians)
...
public void stop() {
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "tri" };
    if (passedArgs != null) {
